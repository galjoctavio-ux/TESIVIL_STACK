...
const AgendarCotizacionModal = ({ cotizacion, onClose, onConfirm }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      setError('Error al agendar la cotización.');
    }
  };

  return (
    <Modal isOpen={true} onClose={onClose}>
      <h2>Agendar Cotización #{cotizacion.id}</h2>
...
export default AgendarCotizacionModal;
